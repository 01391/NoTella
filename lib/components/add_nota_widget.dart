...
class AddNotaWidget extends StatefulWidget {
  const AddNotaWidget({super.key});

  @override
  State<AddNotaWidget> createState() => _AddNotaWidgetState();
}
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Flexible(
              child: SizedBox(
                ...
                child: TextFormField(
                  ...
                  validator:
                      _model.titoloTextControllerValidator.asValidator(context),
                ),
              ),
            ),
            Flexible(
            ...
            FFButtonWidget(
              onPressed: () async {
                await NoteRecord.collection.doc().set(createNoteRecordData(
                      titolo: valueOrDefault<String>(
                        _model.titoloTextController.text,
                        'titolo',
                      ),
                      descrizione: _model.descrizioneTextController.text,
                      completata: false,
                      dataCreazione: getCurrentTimestamp,
                    ));
                Navigator.pop(context);
              },
